          ...
          {posts.map(post => (
            <div key={post.$id} className="rounded-xl border border-slate-200 bg-white p-5 hover:shadow-md transition-shadow flex flex-col justify-between">
              <div>
                ...
                <h3 className="font-bold text-slate-800 line-clamp-1">{post.title || 'Untitled'}</h3>
            ...
            <form onSubmit={handlePostSubmit} className="p-6 space-y-4 max-h-[500px] overflow-y-auto">
              <div>
                ...
                <input
                  ...
                  className="w-full rounded-lg border border-slate-200 bg-white px-4 py-2.5 text-xs text-slate-900 focus:border-[#0d6b66] outline-none"
                />
              </div>
              ...
              <div>
                <label className="block text-xs font-bold text-slate-500 uppercase tracking-wider mb-2">Story Details</label>
                <textarea
                  required
                  ...
                  rows={5}
                  className="w-full rounded-lg border border-slate-200 bg-white px-4 py-2.5 text-xs text-slate-900 focus:border-[#0d6b66] outline-none resize-none"
                />
              </div>
              ...
              {/* Related links */}
              <div>
                <label className="block text-xs font-bold text-slate-500 uppercase tracking-wider mb-2">Related Links (comma separated)</label>
                <input
                  type="text"
